        ...
        <div class="main" "> 
            <p style="font-size: 3rem;">Transaction</p><br>
             <form action="process_transaction.php" method="post">
                    ...
                    <label for="sender_account_number" style="font-size:20px">Account type:</label>
                    <select id="sender_account_type" style="font-size:20px"  name="sender_account_type" required><br><br>
                    <option style="font-size:20px" value="parent">Parent</option>
                    <option style="font-size:20px" value="child">Child</option>
                   </select><br><br>
